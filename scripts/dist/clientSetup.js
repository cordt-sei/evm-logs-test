...
export async function createClient(rpcEndpoint, mnemonic, prefix, gasPriceStr) {
    ...
    client.signAndBroadcast = async (signerAddress, messages, fee) => {
        return originalSignAndBroadcast(signerAddress, messages, calculateFee(FIXED_GAS, gasPrice));
    };
