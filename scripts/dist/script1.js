...
async function main() {
    try {
        ...
        const client = await SigningCosmWasmClient.connectWithSigner(RPC_ENDPOINT, wallet, { gasPrice: GasPrice.fromString("0.1usei") });
        ...
        // Extract pointer address from events
        let pointerAddress = '';
